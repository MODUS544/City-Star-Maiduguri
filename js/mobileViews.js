      ...
      <div class="space-y-3 mb-2">
        ...
        <button onclick="appStore.setMobileScreen(17)" class="w-full py-4 px-5 rounded-2xl bg-brandGray800 border border-brandGray700 text-white font-outfit font-bold text-sm tracking-wide flex items-center justify-between hover:border-brandRed transition-all">
          <div class="flex items-center gap-3">
            ...
            <div class="text-left">
              <div class="text-sm uppercase tracking-wider">POOL & FITNESS HUB</div>
              <div class="text-[10px] text-brandGray200 font-normal">Premium Swimming Pool & Gym Facility</div>
            </div>
          </div>
          <i data-lucide="chevron-right" class="w-5 h-5 text-brandGray200"></i>
        </button>
...
// SCREEN 17: POOL & FITNESS HUB
function renderWellnessLandingScreen() {
  return `
    <div class="relative min-h-[640px] flex flex-col justify-between p-6 bg-cover bg-center rounded-2xl shadow-2xl overflow-hidden" style="background-image: linear-gradient(to bottom, rgba(63, 0, 10, 0.45), rgba(15, 23, 42, 0.96)), url('assets/wellness-hero.jpg');">
      <div class="flex items-center justify-between z-10">
        ...
        <span class="text-xs font-bold text-brandRedLight uppercase tracking-widest px-3 py-1 rounded-full bg-brandMaroonDark/90 border border-brandRed/40">Pool & Fitness Hub</span>
      </div>
      ...
      <div class="my-auto py-6 z-10 space-y-2">
        <span class="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-brandMaroon border border-brandRed/40 text-brandRedLight text-xs font-bold uppercase tracking-wider">
          <i data-lucide="sparkles" class="w-3.5 h-3.5"></i>
          Stay Active. Stay Refreshed.
        </span>
        <h1 class="font-serif font-black text-3xl text-white leading-tight">Pool & Fitness Hub</h1>
        <p class="text-xs text-brandGray200 font-normal leading-relaxed max-w-sm">Premium swimming pool and fully equipped gym facility.</p>
      </div>
      ...
      <div class="p-5 rounded-2xl bg-brandGray800/95 border border-brandGray700 backdrop-blur-xl space-y-3.5 shadow-2xl z-10">
        <div class="flex items-center justify-between text-xs text-white font-bold">
          <span class="flex items-center gap-2 text-brandGray200 font-normal">
            <i data-lucide="clock" class="w-4 h-4 text-brandRedLight"></i> Facility Operating Hours
          </span>
